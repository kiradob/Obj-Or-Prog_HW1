...
//        4. Всё вышеуказанное создать согласно принципам ООП, пройденным на семинаре
        ...
        HotDrink hotTeaSmall = new HotTea("Earl Grey", 2, 180, 80);
        HotDrink hotCoffeeMedium = new HotCoffee("Lavazza", 3, 250, 75);
        HotDrink hotChocolateLarge = new HotChocolate("DeMarco", 4, 380, 70);
        ...
        System.out.println(hotDrinksVending.getProduct("Earl Grey"));
